# Tile Hardware Open License (THOL) / Turkish Conservative Open License (TCOL)
Version 1.1

This Tile Hardware Open License ("THOL" or "TCOL" or "License") is a custom, patent-fortified, hybrid license combining the file-based copyleft principles of the Mozilla Public License 2.0 (MPL 2.0) and the explicit patent protections of the Apache License 2.0. It is uniquely tailored to govern the Covered Software and its related proprietary technologies.
...
1.3. **"Covered Software"** refers to the original source code, any modifications, or any compiled binaries distributed under this License.
...
Subject to the terms and conditions of this License, each Contributor hereby grants You a worldwide, royalty-free, non-exclusive, perpetual copyright license to:
a) Use, compile, reproduce, modify, display, and perform the Covered Software.
b) Distribute the Covered Software or your Modifications, in Source Code or Executable form.
c) Create Larger Works incorporating the Covered Software.

## 3. GRANT OF PATENT LICENSE & EXCLUSIVITY
The Covered Software intricately incorporates Middle Eastern Calculation Machinary Ltd's Proprietary Technologies. 
...
4.1. **Source Code Availability:** Any Modifications made to existing files of the Covered Software must be made available in Source Code form under the terms of this License if You distribute the Covered Software.
4.2. **No Obfuscation:** The Source Code distributed under this License must be the preferred form for making modifications. Obfuscated, encrypted, or artificially minimized code does not satisfy the Source Code distribution requirement.
4.3. **Larger Works:** You may create a Larger Work by combining Covered Software with independent modules in separate files. You may distribute the independent modules under terms of your choice, provided that the files containing the Covered Software remain governed strictly by this License.
...
5.4. **Upstream Ghost Attribution:** In accordance with GHOST_COPYRIGHT, all code derived from the Ghost operating system project must preserve copyright notice attributing Max Schlüssel <lokoxe@gmail.com>.

## 6. ZERO-TRUST ARCHITECTURE, INTEGRITY, AND PROHIBITION OF BACKDOORS
The Covered Software is strictly designed under a deterministic, zero-trust, bare-metal architecture. The security of the HPS and the SECinter layers is paramount.
...
7.2. **Opt-In Requirement:** The Covered Software shall not enforce mandatory data collection. All telemetry must be strictly opt-in, explicitly requested from the end-user.

## 8. NO WARRANTY
8.1. **"AS IS" Basis:** The Covered Software is provided under this License on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied, including, without limitation, any warranties or conditions of TITLE, NON-INFRINGEMENT, MERCHANTABILITY, or FITNESS FOR A PARTICULAR PURPOSE.
...
10.1. **Turkish Law:** This License, and any disputes arising from or related to it, shall be governed by and construed in accordance with the laws of the Republic of Turkey, without reference to its conflict-of-law principles.
10.2. **Exclusive Jurisdiction:** Any legal action or proceeding arising under this License (including patent disputes and criminal complaints under Section 6) will be brought exclusively in the federal, regional, or local courts located within the Republic of Turkey.
10.3. **Patent Enforcement:** Patent rights and protections granted and enforced under this License (especially regarding the Proprietary Technologies) are strictly governed by the Turkish Industrial Property Code (Sınai Mülkiyet Kanunu) No. 6769 and applicable international treaties recognized by the Turkish Patent and Trademark Office (TÜRKPATENT).

## 11. TERMINATION
11.1. **Automatic Termination:** The rights granted under this License will terminate automatically if You fail to comply with any of its terms.
11.2. **Cure Period:** If You cure all violations of this License, then Your License from a particular Contributor is reinstated (a) provisionally, unless and until such Contributor explicitly and finally terminates Your grants, and (b) on an ongoing basis, if such Contributor fails to notify You of the non-compliance by some reasonable means prior to 60 days after You have come back into compliance.
11.3. **Survival:** Provisions that, by their nature, must remain in effect beyond the termination of this License (including but not limited to Sections 3, 6, 8, 9, and 10) shall survive.
